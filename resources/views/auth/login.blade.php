...
<div class="min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 class="text-2xl font-bold text-center text-primary mb-6">Login E-Mading</h2>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    <input type="password" name="password" id="password"
                           class="w-full px-3 py-2 pr-10 border border-gray-300 rounded focus:outline-none focus:border-primary" required>
        ...
        <div class="mt-4 text-center space-y-2">
            ...
            <a href="{{ route('home') }}" class="text-primary hover:text-secondary">Kembali ke Beranda</a>
        </div>
    </div>
</div>
